...
export default function Siteslojas() {
  ...
  <section className="bodybg py-5">
    ...
    <div className="container px-5 my-5 px-5">
      <div className="text-center mb-5">
        <div className="feature bg-gradient text-white rounded-3 mb-3"><i className="bi sitelojastxt bi-envelope" /></div>
        <h2 className="sitelojastxt fw-bolder">Submissão</h2>
        <p className="sitelojastxt lead mb-0">Preencha com os seus dados!</p>
      </div>
      <div className="row gx-5 justify-content-center">
        <div className="col-lg-20 sitelojastxt">
          <form
            onSubmit={SendSave}
