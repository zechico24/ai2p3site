...
export default function Comunicacaoeconsultoria() {
  ...
  <section className=" py-5">
    ...
    <div className="container px-5 my-5 px-5">
      <div className="text-center mb-5">
        <div className="feature bg-gradient text-white rounded-3 mb-3"><i className="bi comunicacaotxt bi-envelope" /></div>
        <h2 className="comunicacaotxt fw-bolder">Submissão</h2>
        <p className="comunicacaotxt lead mb-0">Preencha com os seus dados!</p>
      </div>
      <div className="row gx-5 justify-content-center">
        <div className="col-lg-20 comunicacaotxt">
          <form
            onSubmit={SendSave}
